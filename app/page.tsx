...
export default function Home() {
  return (
    <main>
      ...
      <section className="bg-white py-27.5 px-8 relative">
      ...
      <section className="bg-light-pink py-27.5 px-8">
          ...
          <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white flex flex-col items-center  rounded-b-[20px]">
                ...
                <div className="pt-6 pb-15 flex flex-col items-center gap-4 px-12">
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xl text-medium-gray font-bold ">MARRIAGE COUNSELING</p>
            ...
            <div className="shadow-lg bg-white group-hover:shadow-2xl group rounded-[20px]">
              ...
              <div className="bg-white flex flex-col items-center  rounded-b-[20px]">
                ...
                <div className="pt-6 pb-15 flex flex-col items-center gap-4 px-12">
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xl text-medium-gray font-bold ">FILE DIVORCE AGREEMENT</p>
                    <p className="text-lg font-medium text-medium-gray">Divorce Agreement Filed in Court</p>
                  </div>
      ...
      <section className="bg-white py-27.5 px-8 ">
        <div className="container max-w-7xl mx-auto grid grid-cols-2 gap-4">
      ...
      <section className="bg-aqua relative min-h-108">
        <div className="container max-w-7xl mx-auto px-3 pt-16 flex flex-col items-center">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row min-w-159  gap-3">
              <input
                type="email"
              ...
              <p className="text-sm  text-medium-gray">We care about your data in our <Link href={"/privacy-policy"} className="underline underline-offset-2 text-primary-color font-semibold">privacy policy</Link>.</p>
          </div>
